...
<?php 
		...
		if( isset($_COOKIE[$theme.'_productdetail']) && $listingConfig['enable_paneltool'] && $_COOKIE[$theme.'_productdetail'] ){
			$listingConfig['product_detail'] = trim($_COOKIE[$theme.'_productdetail']);
		}
		else
			$listingConfig['product_detail'] = 'default';

		$productdetail = DIR_TEMPLATE.$theme.'/template/product/detail/'.$listingConfig['product_detail'].'.tpl';	
