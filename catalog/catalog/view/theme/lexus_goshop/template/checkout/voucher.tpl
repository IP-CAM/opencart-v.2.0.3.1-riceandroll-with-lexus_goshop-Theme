  ...
  <div id="collapse-voucher" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <input type="submit" value="<?php echo $button_voucher; ?>" id="button-voucher" data-loading-text="<?php echo $text_loading; ?>"  class="btn btn-sm btn-primary" />
        </span> </div>
...
$('#button-voucher').on('click', function() {
  $.ajax({
    ...
    success: function(json) {
      ...
      if (json['error']) {
        $('.breadcrumb').after('<div class="container"><div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div></div>');
