<div class="interactive-banner interactive-banner-<?php echo $banner_type;?> <?php echo $effect_type;?> <?php echo $position;?>">
	<div class="interactive-banner-body">
        ...
        <div class="interactive-banner-profile text-center">
            ...
            <div class="desception"><?php if($htmlcontent){echo $htmlcontent; }?></div>
            ...
            <?php if($mask_link){?>
                <a class="mask-link btn btn-default" href="<?php echo $mask_link;?>"><span class="space-right-5"><?php if($title_link){echo $title_link;};?></span><i class="text-primary fa fa-long-arrow-right"></i></a>
            <?php } ?>          
        <!-- </div> -->
        </div>
    </div>
