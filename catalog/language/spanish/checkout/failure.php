...
<ul>
  ...
  <li>Verificacion Fallida</li>
</ul>

<p>Por favor trate de ordenar de nuevo utilizando otro método de pago.</p>

<p>If el problema persiste por favor <a href="%s">contactenos</a> con los detalles de la orden que usted está tratando de colocar.</p>
';
