            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-sm-3"><strong><?php echo $location['name']; ?></strong><br />
                  ...
                  <a href="https://maps.google.com/maps?q=<?php echo urlencode($location['geocode']); ?>&hl=en&t=m&z=15" target="_blank" class="btn btn-sm btn-info"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
                  <?php } ?>
                </div>
                                    ...
                                    <div class="media">
                                      ...
                                      <div class="media-body">
                                        <h4 class="media-heading"><?php echo $store; ?></h4>
                                            ...
                                            <?php if ($geocode) { ?>
                                            <a href="https://maps.google.com/maps?q=<?php echo urlencode($geocode); ?>&hl=en&t=m&z=15" target="_blank" class="btn btn-sm btn-info"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
                                            <?php } ?>
                                      </div>
                                    </div>
          ...
          <?php } ?>
                 <div class="buttons">
                  <div class="pull-right">
                    <input class="btn btn-primary btn-sm" type="submit" value="<?php echo $button_submit; ?>" />
                  </div>
                </div>
              </fieldset>
        </div>      
