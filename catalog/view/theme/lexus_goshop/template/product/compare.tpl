   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td class="text-center"><input style="margin: 5px;" type="button" value="<?php echo $button_cart; ?>" class="btn btn-sm btn-success" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" />
            <a style="margin: 5px;" href="<?php echo $product['remove']; ?>" class="btn btn-sm btn-danger"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
      </div>
      ...
      <div class="buttons">
        <div class="pull-right"><a href="<?php echo $continue; ?>" class="btn btn-sm btn-default"><?php echo $button_continue; ?></a></div>
      </div>
      <?php } ?>
