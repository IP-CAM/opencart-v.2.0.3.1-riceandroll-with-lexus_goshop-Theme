  ...
  <div class="row">
   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>">
      ...
      <?php if( false &&  $categories = $helper->getCategoriesById() ){   ?>
	   <div class="subcategories panel panel-default">
        ...
        <?php } else if ($categories) { ?>
          <div class="refine-search panel panel-default panel-v1">
            <div class="panel-heading">
              <h4 class="panel-title"><?php echo $text_refine; ?></h4>
            </div>
            <div class="panel-body">
      ...
      <?php } ?>
        ...
        <div class="buttons">
          <div class="right"><a href="<?php echo $continue; ?>" class="button btn-sm btn btn-default"><?php echo $button_continue; ?></a></div>
        </div>
        <?php } ?>
