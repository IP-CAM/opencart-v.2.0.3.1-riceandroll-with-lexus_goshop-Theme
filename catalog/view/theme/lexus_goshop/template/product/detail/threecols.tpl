...
<div class="product-info">
    <div class="product-inner">
                            ...
                            <h1 class="title-product"><?php echo $heading_title; ?></h1>
                                ...
                                <div id="product">
                                    ...
                                    <div class="action pull-left">
                                        ...
                                        <div class="pull-left">
                                            <button type="button" data-toggle="tooltip" class="compare btn btn-default btn-outline" title="<?php echo $button_compare; ?>" onclick="compare.addcompare('<?php echo $product_id; ?>');"><i class="fa fa-refresh"></i></button>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="clearfix box-product-infomation space-bottom-30 tab-v5">
