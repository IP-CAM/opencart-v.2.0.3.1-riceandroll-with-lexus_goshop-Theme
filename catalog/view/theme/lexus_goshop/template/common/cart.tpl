...
<div id="cart" class="pull-right clearfix">
    ...
    <ul class="dropdown-menu content">
      ...
      <li>
        <div class="table-responsive space-padding-20">
          ...
          <p class="text-right space-tb-10">
            <a href="<?php echo $cart; ?>" class="btn btn-sm btn-primary btn-outline">
              <?php echo $text_cart; ?>
            </a>&nbsp;&nbsp;&nbsp;
            <a href="<?php echo $checkout; ?>" class="btn btn-sm btn-primary btn-outline">
