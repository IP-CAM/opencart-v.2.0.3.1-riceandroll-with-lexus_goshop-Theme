...
$headerlayouts   = array('default' => 'Header V1','header-2' => 'Header V2'); 

$productdetails=array('default' => 'Produt Detail 1','accordion' => 'Produt Detail 2'); 	
					...
					<div class="group-input row">
						...
						<select class="col-sm-7" name="userparams[headerlayout]">
							<?php foreach( $headerlayouts as $k=>$skin ) {  $skin = basename($skin) ; 
								$selected = '';
								if(isset($_COOKIE[$themeName.'_headerlayout'])) {
									if($_COOKIE[$themeName.'_headerlayout'] == $k){
										$selected = "selected='selected'";
									}
								}
							?>
							<option value="<?php echo ($k);?>" <?php echo $selected; ?> <?php if( $this->getParam('headerlayout') == $k ) { ?> selected="selected" <?php } ?>><?php echo ($skin);?></option>
							<?php } ?>
						</select>					
					</div> 
				 	<div class="group-input row">
						<label class="col-sm-5" >Product Detail Layout</label>
						<select class="col-sm-7" name="userparams[productdetail]">
							<?php foreach( $productdetails as $k=>$skin ) {  $skin = basename($skin) ; 
								$selected = '';
								if(isset($_COOKIE[$themeName.'_productdetail'])) {
									if($_COOKIE[$themeName.'_productdetail'] == $k){
										$selected = "selected='selected'";
									}
								}
							?>
							<option value="<?php echo ($k);?>" <?php echo $selected; ?> <?php if( $this->getParam('productdetail') == $k ) { ?> selected="selected" <?php } ?>><?php echo ($skin);?></option>
							<?php } ?>
						</select>				
					</div> 
