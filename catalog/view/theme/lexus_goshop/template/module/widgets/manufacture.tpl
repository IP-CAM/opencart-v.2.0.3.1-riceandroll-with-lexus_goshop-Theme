<?php $id = rand(1,10); $span =  12/$columns; ?>
   	<div id="pavcarousel<?php echo $id;?>" class="widget-carousel panel panel-default panel-v1 pavcarousel slide <?php echo $addition_cls; ?>  <?php if( isset($stylecls)&&$stylecls ) { ?>box-<?php echo $stylecls;?><?php } ?>">
		<?php if( $show_title ) { ?>
			...
			<div class="carousel-inner">
				...
				<div class="item <?php if($k==0) {?>active<?php } ?>">
					<?php foreach( $tbanners as $i => $banner ) {  $i=$i+1;?>
						...
						<div class="col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-<?php echo $span;?> col-xs-4">
