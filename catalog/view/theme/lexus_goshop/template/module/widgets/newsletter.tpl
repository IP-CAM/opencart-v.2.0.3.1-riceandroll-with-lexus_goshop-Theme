<div id="newsletter_block_footer" class="panel <?php echo $class;?> <?php if(isset($stylecls)&&$stylecls){echo "block-".$stylecls;} ?>">
        ...
        <div class="panel-body">            
            ...
            <form action="#" method="post">
                <div class="input-group">
                    <input class="form-control" id="newsletter-input-footer" type="text" name="email"  placeholder="<?php if(isset($value) && $value){ echo $value; }else{ echo "EMAIL@DOMAIN.COM";} ?>" />
                    <input type="hidden" name="action" value="0" />
                    <div class="input-group-btn">
                        <button type="submit" class="btn btn-primary" name="submitNewsletter" ><i class="fa fa-envelope"></i></button>
                    </div>
