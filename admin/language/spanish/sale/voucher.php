<?php
// Heading  
$_['heading_title']     = 'Vale de regalo';

// Text
$_['text_send']         = 'Enviar';
$_['text_success']      = 'Éxito: has modificado vales!';
$_['text_sent']         = 'Éxito: Un Vale de Regalo se ha enviado por E-Mail!';
$_['text_wait']         = 'Por favor Espere!';

// Column
$_['column_name']       = 'Nombre vale';
...
// Entry
$_['entry_code']        = 'Código:<br /><span class="help">El código que el usuario introduce para activar el vale.</span>';
$_['entry_from_name']   = 'Nombre emisor:';
$_['entry_from_email']  = 'E-Mail emisor:';
...
// Error
$_['error_permission']  = 'Cuidado: No tienes permisos para modificar vales!';
