<?php
// HTTP
define('HTTP_SERVER', 'http://45.55.83.34/admin/');
define('HTTP_CATALOG', 'http://45.55.83.34/');

// HTTPS
define('HTTPS_SERVER', 'http://45.55.83.34/admin/');
define('HTTPS_CATALOG', 'http://45.55.83.34/');
